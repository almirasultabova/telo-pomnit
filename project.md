...
Запуск нового потока намечен на октябрь 2026. Точные даты и расписание встреч — пока не определены.
...
- обновить даты/цены на лендинге (`landing_final.html`), если открывается новая запись
