...
#### Лист ожидания (не оплата — см. `project.md`, раздел «Запись на поток»)
- [ ] Кнопки «Встать в лист ожидания» и «Участвовать» открывают модальное окно с полями email + Telegram
