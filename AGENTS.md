# AGENTS.md — Правила работы с проектом «Тело помнит»

> Этот файл — копия правил из [CLAUDE.md](CLAUDE.md) для агентов, которые не читают
> CLAUDE.md напрямую. При правке CLAUDE.md обнови и этот файл — иначе он снова устареет.
